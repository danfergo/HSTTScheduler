...
${OBJECTDIR}/engine/evaluator/Cost.o: engine/evaluator/Cost.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/evaluator/Cost.o engine/evaluator/Cost.cpp

${OBJECTDIR}/engine/evaluator/Evaluator.o: engine/evaluator/Evaluator.cpp 
	${MKDIR} -p ${OBJECTDIR}/engine/evaluator
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/evaluator/Evaluator.o engine/evaluator/Evaluator.cpp

${OBJECTDIR}/engine/io/Utils.o: engine/io/Utils.cpp 
	${MKDIR} -p ${OBJECTDIR}/engine/io
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/io/Utils.o engine/io/Utils.cpp

${OBJECTDIR}/engine/io/XHSTTExporter.o: engine/io/XHSTTExporter.cpp 
	${MKDIR} -p ${OBJECTDIR}/engine/io
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/io/XHSTTExporter.o engine/io/XHSTTExporter.cpp

${OBJECTDIR}/engine/io/XHSTTImporter.o: engine/io/XHSTTImporter.cpp 
	${MKDIR} -p ${OBJECTDIR}/engine/io
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/io/XHSTTImporter.o engine/io/XHSTTImporter.cpp

${OBJECTDIR}/engine/model/Schedule.o: engine/model/Schedule.cpp 
	${MKDIR} -p ${OBJECTDIR}/engine/model
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/Schedule.o engine/model/Schedule.cpp
...
${OBJECTDIR}/engine/model/constraints/AssignResourceConstraint.o: engine/model/constraints/AssignResourceConstraint.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/constraints/AssignResourceConstraint.o engine/model/constraints/AssignResourceConstraint.cpp

${OBJECTDIR}/engine/model/constraints/AssignTimeConstraint.o: engine/model/constraints/AssignTimeConstraint.cpp 
	${MKDIR} -p ${OBJECTDIR}/engine/model/constraints
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/constraints/AssignTimeConstraint.o engine/model/constraints/AssignTimeConstraint.cpp

${OBJECTDIR}/engine/model/constraints/AvoidClashesConstraint.o: engine/model/constraints/AvoidClashesConstraint.cpp 
	${MKDIR} -p ${OBJECTDIR}/engine/model/constraints
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/constraints/AvoidClashesConstraint.o engine/model/constraints/AvoidClashesConstraint.cpp

${OBJECTDIR}/engine/model/constraints/Constraint.o: engine/model/constraints/Constraint.cpp 
	${MKDIR} -p ${OBJECTDIR}/engine/model/constraints
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/constraints/Constraint.o engine/model/constraints/Constraint.cpp

${OBJECTDIR}/engine/model/constraints/EventGroupsBasedContraint.o: engine/model/constraints/EventGroupsBasedContraint.cpp 
	${MKDIR} -p ${OBJECTDIR}/engine/model/constraints
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/constraints/EventGroupsBasedContraint.o engine/model/constraints/EventGroupsBasedContraint.cpp

${OBJECTDIR}/engine/model/constraints/PreferResourcesConstraint.o: engine/model/constraints/PreferResourcesConstraint.cpp 
	${MKDIR} -p ${OBJECTDIR}/engine/model/constraints
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/constraints/PreferResourcesConstraint.o engine/model/constraints/PreferResourcesConstraint.cpp
...
${OBJECTDIR}/engine/model/constraints/ResourceGroupsBasedContraint.o: engine/model/constraints/ResourceGroupsBasedContraint.cpp 
	${MKDIR} -p ${OBJECTDIR}/engine/model/constraints
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/constraints/ResourceGroupsBasedContraint.o engine/model/constraints/ResourceGroupsBasedContraint.cpp

${OBJECTDIR}/engine/model/events/Course.o: engine/model/events/Course.cpp 
	${MKDIR} -p ${OBJECTDIR}/engine/model/events
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/events/Course.o engine/model/events/Course.cpp

${OBJECTDIR}/engine/model/events/Event.o: engine/model/events/Event.cpp 
	${MKDIR} -p ${OBJECTDIR}/engine/model/events
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/events/Event.o engine/model/events/Event.cpp

${OBJECTDIR}/engine/model/events/EventGroup.o: engine/model/events/EventGroup.cpp 
	${MKDIR} -p ${OBJECTDIR}/engine/model/events
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/events/EventGroup.o engine/model/events/EventGroup.cpp

${OBJECTDIR}/engine/model/resources/Resource.o: engine/model/resources/Resource.cpp 
	${MKDIR} -p ${OBJECTDIR}/engine/model/resources
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/resources/Resource.o engine/model/resources/Resource.cpp

${OBJECTDIR}/engine/model/resources/ResourceGroup.o: engine/model/resources/ResourceGroup.cpp 
	${MKDIR} -p ${OBJECTDIR}/engine/model/resources
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/resources/ResourceGroup.o engine/model/resources/ResourceGroup.cpp

${OBJECTDIR}/engine/model/resources/ResourceType.o: engine/model/resources/ResourceType.cpp 
	${MKDIR} -p ${OBJECTDIR}/engine/model/resources
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/resources/ResourceType.o engine/model/resources/ResourceType.cpp

${OBJECTDIR}/engine/model/resources/Role.o: engine/model/resources/Role.cpp 
	${MKDIR} -p ${OBJECTDIR}/engine/model/resources
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/resources/Role.o engine/model/resources/Role.cpp

${OBJECTDIR}/engine/model/solutions/SolEvent.o: engine/model/solutions/SolEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}/engine/model/solutions
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/solutions/SolEvent.o engine/model/solutions/SolEvent.cpp

${OBJECTDIR}/engine/model/solutions/Solution.o: engine/model/solutions/Solution.cpp 
	${MKDIR} -p ${OBJECTDIR}/engine/model/solutions
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/solutions/Solution.o engine/model/solutions/Solution.cpp

${OBJECTDIR}/engine/model/times/Day.o: engine/model/times/Day.cpp 
	${MKDIR} -p ${OBJECTDIR}/engine/model/times
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/times/Day.o engine/model/times/Day.cpp

${OBJECTDIR}/engine/model/times/Time.o: engine/model/times/Time.cpp 
	${MKDIR} -p ${OBJECTDIR}/engine/model/times
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/times/Time.o engine/model/times/Time.cpp

${OBJECTDIR}/engine/model/times/TimeGroup.o: engine/model/times/TimeGroup.cpp 
	${MKDIR} -p ${OBJECTDIR}/engine/model/times
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/times/TimeGroup.o engine/model/times/TimeGroup.cpp

${OBJECTDIR}/engine/model/times/Week.o: engine/model/times/Week.cpp 
	${MKDIR} -p ${OBJECTDIR}/engine/model/times
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/times/Week.o engine/model/times/Week.cpp

${OBJECTDIR}/lib/tinyxml2/tinyxml2.o: lib/tinyxml2/tinyxml2.cpp 
	${MKDIR} -p ${OBJECTDIR}/lib/tinyxml2
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/tinyxml2/tinyxml2.o lib/tinyxml2/tinyxml2.cpp
...
${TESTDIR}/tests/XHSTTImporterSudoku4x4Test.o: tests/XHSTTImporterSudoku4x4Test.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/XHSTTImporterSudoku4x4Test.o tests/XHSTTImporterSudoku4x4Test.cpp


${TESTDIR}/tests/XHSTTImporterArtificialAbramson15Test.o: tests/XHSTTImporterArtificialAbramson15Test.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/XHSTTImporterArtificialAbramson15Test.o tests/XHSTTImporterArtificialAbramson15Test.cpp
...
${OBJECTDIR}/engine/evaluator/Cost_nomain.o: ${OBJECTDIR}/engine/evaluator/Cost.o engine/evaluator/Cost.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/evaluator/Cost_nomain.o engine/evaluator/Cost.cpp;\
	else  \
...
${OBJECTDIR}/engine/evaluator/Evaluator_nomain.o: ${OBJECTDIR}/engine/evaluator/Evaluator.o engine/evaluator/Evaluator.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/evaluator/Evaluator_nomain.o engine/evaluator/Evaluator.cpp;\
	else  \
...
${OBJECTDIR}/engine/io/Utils_nomain.o: ${OBJECTDIR}/engine/io/Utils.o engine/io/Utils.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/io/Utils_nomain.o engine/io/Utils.cpp;\
	else  \
...
${OBJECTDIR}/engine/io/XHSTTExporter_nomain.o: ${OBJECTDIR}/engine/io/XHSTTExporter.o engine/io/XHSTTExporter.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/io/XHSTTExporter_nomain.o engine/io/XHSTTExporter.cpp;\
	else  \
...
${OBJECTDIR}/engine/io/XHSTTImporter_nomain.o: ${OBJECTDIR}/engine/io/XHSTTImporter.o engine/io/XHSTTImporter.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/io/XHSTTImporter_nomain.o engine/io/XHSTTImporter.cpp;\
	else  \
...
${OBJECTDIR}/engine/model/Schedule_nomain.o: ${OBJECTDIR}/engine/model/Schedule.o engine/model/Schedule.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/Schedule_nomain.o engine/model/Schedule.cpp;\
	else  \
...
${OBJECTDIR}/engine/model/constraints/AssignResourceConstraint_nomain.o: ${OBJECTDIR}/engine/model/constraints/AssignResourceConstraint.o engine/model/constraints/AssignResourceConstraint.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/constraints/AssignResourceConstraint_nomain.o engine/model/constraints/AssignResourceConstraint.cpp;\
	else  \
...
${OBJECTDIR}/engine/model/constraints/AssignTimeConstraint_nomain.o: ${OBJECTDIR}/engine/model/constraints/AssignTimeConstraint.o engine/model/constraints/AssignTimeConstraint.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/constraints/AssignTimeConstraint_nomain.o engine/model/constraints/AssignTimeConstraint.cpp;\
	else  \
...
${OBJECTDIR}/engine/model/constraints/AvoidClashesConstraint_nomain.o: ${OBJECTDIR}/engine/model/constraints/AvoidClashesConstraint.o engine/model/constraints/AvoidClashesConstraint.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/constraints/AvoidClashesConstraint_nomain.o engine/model/constraints/AvoidClashesConstraint.cpp;\
	else  \
...
${OBJECTDIR}/engine/model/constraints/Constraint_nomain.o: ${OBJECTDIR}/engine/model/constraints/Constraint.o engine/model/constraints/Constraint.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/constraints/Constraint_nomain.o engine/model/constraints/Constraint.cpp;\
	else  \
...
${OBJECTDIR}/engine/model/constraints/EventGroupsBasedContraint_nomain.o: ${OBJECTDIR}/engine/model/constraints/EventGroupsBasedContraint.o engine/model/constraints/EventGroupsBasedContraint.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/constraints/EventGroupsBasedContraint_nomain.o engine/model/constraints/EventGroupsBasedContraint.cpp;\
	else  \
...
${OBJECTDIR}/engine/model/constraints/PreferResourcesConstraint_nomain.o: ${OBJECTDIR}/engine/model/constraints/PreferResourcesConstraint.o engine/model/constraints/PreferResourcesConstraint.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/constraints/PreferResourcesConstraint_nomain.o engine/model/constraints/PreferResourcesConstraint.cpp;\
	else  \
...
${OBJECTDIR}/engine/model/constraints/ResourceGroupsBasedContraint_nomain.o: ${OBJECTDIR}/engine/model/constraints/ResourceGroupsBasedContraint.o engine/model/constraints/ResourceGroupsBasedContraint.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/constraints/ResourceGroupsBasedContraint_nomain.o engine/model/constraints/ResourceGroupsBasedContraint.cpp;\
	else  \
...
${OBJECTDIR}/engine/model/events/Course_nomain.o: ${OBJECTDIR}/engine/model/events/Course.o engine/model/events/Course.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/events/Course_nomain.o engine/model/events/Course.cpp;\
	else  \
...
${OBJECTDIR}/engine/model/events/Event_nomain.o: ${OBJECTDIR}/engine/model/events/Event.o engine/model/events/Event.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/events/Event_nomain.o engine/model/events/Event.cpp;\
	else  \
...
${OBJECTDIR}/engine/model/events/EventGroup_nomain.o: ${OBJECTDIR}/engine/model/events/EventGroup.o engine/model/events/EventGroup.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/events/EventGroup_nomain.o engine/model/events/EventGroup.cpp;\
	else  \
...
${OBJECTDIR}/engine/model/resources/Resource_nomain.o: ${OBJECTDIR}/engine/model/resources/Resource.o engine/model/resources/Resource.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/resources/Resource_nomain.o engine/model/resources/Resource.cpp;\
	else  \
...
${OBJECTDIR}/engine/model/resources/ResourceGroup_nomain.o: ${OBJECTDIR}/engine/model/resources/ResourceGroup.o engine/model/resources/ResourceGroup.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/resources/ResourceGroup_nomain.o engine/model/resources/ResourceGroup.cpp;\
	else  \
...
${OBJECTDIR}/engine/model/resources/ResourceType_nomain.o: ${OBJECTDIR}/engine/model/resources/ResourceType.o engine/model/resources/ResourceType.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/resources/ResourceType_nomain.o engine/model/resources/ResourceType.cpp;\
	else  \
...
${OBJECTDIR}/engine/model/resources/Role_nomain.o: ${OBJECTDIR}/engine/model/resources/Role.o engine/model/resources/Role.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/resources/Role_nomain.o engine/model/resources/Role.cpp;\
	else  \
...
${OBJECTDIR}/engine/model/solutions/SolEvent_nomain.o: ${OBJECTDIR}/engine/model/solutions/SolEvent.o engine/model/solutions/SolEvent.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/solutions/SolEvent_nomain.o engine/model/solutions/SolEvent.cpp;\
	else  \
...
${OBJECTDIR}/engine/model/solutions/Solution_nomain.o: ${OBJECTDIR}/engine/model/solutions/Solution.o engine/model/solutions/Solution.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/solutions/Solution_nomain.o engine/model/solutions/Solution.cpp;\
	else  \
...
${OBJECTDIR}/engine/model/times/Day_nomain.o: ${OBJECTDIR}/engine/model/times/Day.o engine/model/times/Day.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/times/Day_nomain.o engine/model/times/Day.cpp;\
	else  \
...
${OBJECTDIR}/engine/model/times/Time_nomain.o: ${OBJECTDIR}/engine/model/times/Time.o engine/model/times/Time.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/times/Time_nomain.o engine/model/times/Time.cpp;\
	else  \
...
${OBJECTDIR}/engine/model/times/TimeGroup_nomain.o: ${OBJECTDIR}/engine/model/times/TimeGroup.o engine/model/times/TimeGroup.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/times/TimeGroup_nomain.o engine/model/times/TimeGroup.cpp;\
	else  \
...
${OBJECTDIR}/engine/model/times/Week_nomain.o: ${OBJECTDIR}/engine/model/times/Week.o engine/model/times/Week.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/model/times/Week_nomain.o engine/model/times/Week.cpp;\
	else  \
...
${OBJECTDIR}/lib/tinyxml2/tinyxml2_nomain.o: ${OBJECTDIR}/lib/tinyxml2/tinyxml2.o lib/tinyxml2/tinyxml2.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/tinyxml2/tinyxml2_nomain.o lib/tinyxml2/tinyxml2.cpp;\
	else  \
